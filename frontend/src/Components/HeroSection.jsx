...
const HeroSection = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-center lg:items-start justify-center  gap-8  min-h-fit">
        ...
        <div className="flex-1 max-w-xl mt-24">
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            opportunities. Whether you're learning new skills, exploring
            different fields, or pursuing higher education, the journey of
            learning is one of the most fulfilling experiences. Embrace
            education as a lifelong pursuit and watch yourself grow beyond
            limits.
          </p>
